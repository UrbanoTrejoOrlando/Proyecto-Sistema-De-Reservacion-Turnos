...
const ReservarCita = () => {
  ...
  // Obtener servicio si no viene por location.state
  useEffect(() => {
  ...
  const handleBookAppointment = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Error al reservar cita');
      }
      ...
      navigate('/cliente'); // Cambiado de /mis-citas a /cliente
    } catch (err) {
      setError(err.message);
      Swal.fire({
        icon: 'error',
  ...
  if (loading) {
    return <div className="text-center py-12">Cargando servicio...</div>;
  }
  if (!service) {
    return (
      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {availableSlotsCount === 0 && selectedDate && (
